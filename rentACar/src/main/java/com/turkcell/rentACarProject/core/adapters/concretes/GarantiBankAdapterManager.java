...
public class GarantiBankAdapterManager implements BankAdapterService{
	...
	@Override
	public Result checkIfLimitIsEnough(String cardNo, String year, String mounth, String cVV, double amount) { //createPaymental 
		
		GarantiBank garantiBank = new GarantiBank();
		if(garantiBank.isLimitExists(cardNo, year, mounth, cVV, amount))	{ // createpaymenttan yap
